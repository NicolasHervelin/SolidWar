...
public class RLearnerForSolidWar {
    RLWorld thisWorld;
    ...
    */
    ...
    public RLPolicyForSolidWar getPolicy() {
    ...
    public RLPolicyForSolidWar newPolicy() {
        policy = new RLPolicyForSolidWar( dimSize );
        // Initializing the policy with the initial values defined by the world.
        policy.initValues( thisWorld.getInitValues() );
        return policy;
